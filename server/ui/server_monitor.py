...
class Ui_ServerWindow(object):
    def setupUi(self, ServerWindow):
        ...
        self.centralwidget.setStyleSheet("background-color: #ECECEC;")  # Изменение цвета фона
    ...
    def retranslateUi(self, ServerWindow):
        ...
        ServerWindow.setWindowTitle(_translate("ServerWindow", "Моніторинг сервера"))
        self.tabWidgetClients.setTabText(self.tabWidgetClients.indexOf(self.tab), _translate("ServerWindow", "Клієнти"))
        self.tabWidgetClients.setTabText(self.tabWidgetClients.indexOf(self.tab_2), _translate("ServerWindow", "Історія з'єднань"))
        self.menuactions.setTitle(_translate("ServerWindow", "Дії"))
        self.refresh_action.setText(_translate("ServerWindow", "Оновити"))
