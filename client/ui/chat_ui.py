...
class Ui_ChatMainWindow(object):
    def setupUi(self, ChatMainWindow):
        ...
        self.send_btn.setStyleSheet("font-size: 12pt; font-weight: bold; background-color: #FF0000; color: white;")  # Modified font, color, and background
    ...
    def retranslateUi(self, ChatMainWindow):
        ...
        ChatMainWindow.setWindowTitle(_translate("ChatMainWindow", "Вікно чату"))
        self.send_btn.setText(_translate("ChatMainWindow", "Відправити"))
